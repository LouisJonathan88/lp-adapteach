...
//     <div className="bg-[#313234] p-8 rounded-xl shadow-xl transition-all duration-300 flex flex-col items-start gap-6 h-full">
...
//         {/* HEADER */}
//         <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-24 mb-20">
...
export const Manfaat: React.FC = () => {
  ...
  // 1. Definisi Varians untuk Staggered Effect
  ...
  const CardItem = ({ item }: any) => (
    // 2. Gunakan motion.div dengan varians item
    <motion.div 
  ...
  return (
    <section className="w-full py-24 bg-[#191D22] text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* HEADER dengan Reveal sederhana */}
        <motion.div 
        ...
        {/* 3. Container Grid dengan Staggered Entry */}
        <motion.div 
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: false, amount: 0.2 }} // Muncul saat 20% bagian masuk layar
